package com.example.mediabytho;
...
import com.example.mediabytho.MyService.MyBinder;
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView btOn = (ImageView) findViewById(R.id.btOn);
        final ImageView btOff = (ImageView) findViewById(R.id.btoff);
        final ImageView btFast = (ImageView) findViewById(R.id.bttien);
        final ImageView btPlay = (ImageView) findViewById(R.id.play);
        final ImageView btTua=(ImageView) findViewById(R.id.btlui);
